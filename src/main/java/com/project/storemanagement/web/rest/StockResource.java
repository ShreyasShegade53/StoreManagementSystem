...
import com.project.storemanagement.repository.StockRepository;
...
/**
 * REST controller for managing {@link com.project.storemanagement.domain.Stock}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Stock> result = stockRepository
            ...
            .map(existingStock -> {
                ...
                if (stock.getSalePrice() != null) {
                    existingStock.setSalePrice(stock.getSalePrice());
                }
