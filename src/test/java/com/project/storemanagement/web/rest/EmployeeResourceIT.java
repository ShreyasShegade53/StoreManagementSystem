...
import com.project.storemanagement.repository.EmployeeRepository;
...
class EmployeeResourceIT {
    ...
    void putExistingEmployee() throws Exception {
        ...
        updatedEmployee.name(UPDATED_NAME).address(UPDATED_ADDRESS).phoneNo(UPDATED_PHONE_NO).job(UPDATED_JOB).username(UPDATED_USERNAME);
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.address(UPDATED_ADDRESS).phoneNo(UPDATED_PHONE_NO);
