...
import com.project.storemanagement.domain.Product;
...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().name(DEFAULT_NAME).category(DEFAULT_CATEGORY).company(DEFAULT_COMPANY);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).category(UPDATED_CATEGORY).company(UPDATED_COMPANY);
        return product;
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).category(UPDATED_CATEGORY).company(UPDATED_COMPANY);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).category(UPDATED_CATEGORY).company(UPDATED_COMPANY);
